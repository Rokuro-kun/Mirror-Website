function S123MagicButton(settings) {
    ...
    function Data() {
        ...
        var supportedNetworks = {
            ...
            microsoftTeams: new Item({
                isActive: false,
                order: 14,
                icon: '<img src="' + _.$GLOBALS['cdn-system-files'] + '/files/icons/socialNetworksBrands/microsoft-teams-icon.svg?v=' + _.$GLOBALS['v-cache'] + '">',
                value: '',
                messageName: 'Microsoft Teams',
                title: _.translations.microsoftTeams.title,
                action: {
                    contact: 'href="https://teams.microsoft.com/l/call/0/0?users=4:{{value}}" target="_blank"',
                    share: '',
                }
            }),
        };
        ...
        loadCssFile(function() {
            if (IsWizard() || $magicButtonSettings.active) {
                S123.contactMagicButton = new S123MagicButton({
                    ...
                    type: 'contact',
                    availableNetworks: ['faceBookMessanger', 'whatsApp', 'phone', 'contactUs', 'skype', 'telegram', 'microsoftTeams'],
